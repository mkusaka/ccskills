...
metadata:
  ...
  source:
    ...
    ref: "main"
    path: "system-prompts/skill-workflow-authoring-reference.md"
  variables:
    - "WORKFLOW_INVOCATION_QUALIFIER"
    - "WORKFLOW_SCRIPT_PATH_NOTE"
    - "SUBAGENT_MODEL_FORCE"
    - "WORKFLOW_AGENT_ISOLATION_TYPE"
