...
metadata:
  originalName: "Skill: Verify CLI changes (example for Verify skill)"
  ccVersion: "2.1.83"
  sourceUrl: "https://github.com/Piebald-AI/claude-code-system-prompts/blob/main/system-prompts/skill-verify-cli-changes-example-for-verify-skill.md"
  source:
    owner: "Piebald-AI"
    repo: "claude-code-system-prompts"
    ref: "main"
    path: "system-prompts/skill-verify-cli-changes-example-for-verify-skill.md"
---
