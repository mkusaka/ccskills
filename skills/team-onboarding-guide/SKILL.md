...
metadata:
  originalName: "Skill: Team onboarding guide"
  ccVersion: "2.1.94"
  sourceUrl: "https://github.com/Piebald-AI/claude-code-system-prompts/blob/main/system-prompts/skill-team-onboarding-guide.md"
  source:
    owner: "Piebald-AI"
    repo: "claude-code-system-prompts"
    ref: "main"
    path: "system-prompts/skill-team-onboarding-guide.md"
---
