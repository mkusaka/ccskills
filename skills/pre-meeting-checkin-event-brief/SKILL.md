---
name: "pre-meeting-checkin-event-brief"
...
metadata:
  originalName: "Skill: /pre-meeting-checkin event brief"
  ccVersion: "2.1.119"
  sourceUrl: "https://github.com/Piebald-AI/claude-code-system-prompts/blob/main/system-prompts/skill-pre-meeting-checkin-event-brief.md"
  source:
    owner: "Piebald-AI"
    repo: "claude-code-system-prompts"
    ref: "main"
    path: "system-prompts/skill-pre-meeting-checkin-event-brief.md"
---
