---
name: "loop-cloud-first-scheduling-offer"
...
metadata:
  originalName: "Skill: /loop cloud-first scheduling offer"
  ccVersion: "2.1.101"
  sourceUrl: "https://github.com/Piebald-AI/claude-code-system-prompts/blob/main/system-prompts/skill-loop-cloud-first-scheduling-offer.md"
  source:
    owner: "Piebald-AI"
    repo: "claude-code-system-prompts"
    ref: "main"
    path: "system-prompts/skill-loop-cloud-first-scheduling-offer.md"
  variables:
