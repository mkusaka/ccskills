---
name: "setup-cowork-role-selection"
...
metadata:
  originalName: "Skill: Setup Cowork role selection"
  ccVersion: "2.1.199"
  sourceUrl: "https://github.com/Piebald-AI/claude-code-system-prompts/blob/main/system-prompts/skill-setup-cowork-role-selection.md"
  source:
    owner: "Piebald-AI"
    repo: "claude-code-system-prompts"
    ref: "main"
    path: "system-prompts/skill-setup-cowork-role-selection.md"
  variables:
    - "COWORK_ROLE_OPTIONS"
    - "COWORK_ROLE_OPTION"
---
