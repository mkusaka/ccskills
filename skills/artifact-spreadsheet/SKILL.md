...
description: "Skill instructions for creating live editable spreadsheet artifacts with persistable rows, formulas, sorting, comments, and template-preservation requirements"
metadata:
  originalName: "Skill: Artifact spreadsheet"
  ccVersion: "2.1.228"
  sourceUrl: "https://github.com/Piebald-AI/claude-code-system-prompts/blob/main/system-prompts/skill-artifact-spreadsheet.md"
  source:
    owner: "Piebald-AI"
    repo: "claude-code-system-prompts"
    ref: "main"
    path: "system-prompts/skill-artifact-spreadsheet.md"
---
