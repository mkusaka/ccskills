...
description: "Skill instructions for creating editable slide-deck Artifacts with slide-editor navigation, presentation mode, notes, comments, and template-preservation requirements"
metadata:
