---
name: "artifact-slides"
description: "Skill instructions for creating live editable slide-deck Artifacts with slide-editor navigation, presentation mode, notes, comments, and template-preservation requirements"
metadata:
  originalName: "Skill: Artifact slides"
  ccVersion: "2.1.229"
  sourceUrl: "https://github.com/Piebald-AI/claude-code-system-prompts/blob/main/system-prompts/skill-artifact-slides.md"
  source:
    owner: "Piebald-AI"
    repo: "claude-code-system-prompts"
    ref: "main"
    path: "system-prompts/skill-artifact-slides.md"
---
