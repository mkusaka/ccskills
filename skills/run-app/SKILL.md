...
metadata:
  originalName: "Skill: Run app"
  ccVersion: "2.1.145"
  sourceUrl: "https://github.com/Piebald-AI/claude-code-system-prompts/blob/main/system-prompts/skill-run-app.md"
  source:
    owner: "Piebald-AI"
    repo: "claude-code-system-prompts"
    ref: "main"
    path: "system-prompts/skill-run-app.md"
---
