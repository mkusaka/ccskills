...
description: "Runs an iterative decision workshop through a published Artifact, applying reader choices and republishing until the reader kicks off the build"
metadata:
