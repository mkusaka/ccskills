...
description: "Runs an iterative decision workshop through a published Artifact, applies reader choices through build kickoff, and updates the living record with shipped deliverables"
metadata:
