...
metadata:
  originalName: "Skill: Computer Use MCP"
  ccVersion: "2.1.89"
  sourceUrl: "https://github.com/Piebald-AI/claude-code-system-prompts/blob/main/system-prompts/skill-computer-use-mcp.md"
  source:
    owner: "Piebald-AI"
    repo: "claude-code-system-prompts"
    ref: "main"
    path: "system-prompts/skill-computer-use-mcp.md"
---
