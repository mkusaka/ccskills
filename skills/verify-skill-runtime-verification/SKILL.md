---
name: "verify-skill-runtime-verification"
...
metadata:
  originalName: "Skill: Verify skill (runtime-verification)"
  ccVersion: "2.1.105"
  sourceUrl: "https://github.com/Piebald-AI/claude-code-system-prompts/blob/main/system-prompts/skill-verify-skill-runtime-verification.md"
  source:
    owner: "Piebald-AI"
    repo: "claude-code-system-prompts"
    ref: "main"
    path: "system-prompts/skill-verify-skill-runtime-verification.md"
---
