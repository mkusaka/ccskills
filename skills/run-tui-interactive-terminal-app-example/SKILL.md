---
name: "run-tui-interactive-terminal-app-example"
...
metadata:
  originalName: "Skill: Run TUI interactive terminal app example"
  ccVersion: "2.1.145"
  sourceUrl: "https://github.com/Piebald-AI/claude-code-system-prompts/blob/main/system-prompts/skill-run-tui-interactive-terminal-app-example.md"
  source:
    owner: "Piebald-AI"
    repo: "claude-code-system-prompts"
    ref: "main"
    path: "system-prompts/skill-run-tui-interactive-terminal-app-example.md"
---
