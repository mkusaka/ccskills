...
metadata:
  originalName: "Skill: Run skill template"
  ccVersion: "2.1.145"
  sourceUrl: "https://github.com/Piebald-AI/claude-code-system-prompts/blob/main/system-prompts/skill-run-skill-template.md"
  source:
    owner: "Piebald-AI"
    repo: "claude-code-system-prompts"
    ref: "main"
    path: "system-prompts/skill-run-skill-template.md"
---
