...
metadata:
  originalName: "Skill: Prototype description"
  ccVersion: "2.1.229"
  sourceUrl: "https://github.com/Piebald-AI/claude-code-system-prompts/blob/main/system-prompts/skill-prototype-description.md"
  source:
    owner: "Piebald-AI"
    repo: "claude-code-system-prompts"
    ref: "main"
    path: "system-prompts/skill-prototype-description.md"
---
