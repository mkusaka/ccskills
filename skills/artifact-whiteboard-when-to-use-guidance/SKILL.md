---
name: "artifact-whiteboard-when-to-use-guidance"
...
metadata:
  originalName: "Skill: Artifact whiteboard when-to-use guidance"
  ccVersion: "2.1.218"
  sourceUrl: "https://github.com/Piebald-AI/claude-code-system-prompts/blob/main/system-prompts/skill-artifact-whiteboard-when-to-use-guidance.md"
  source:
    owner: "Piebald-AI"
    repo: "claude-code-system-prompts"
    ref: "main"
    path: "system-prompts/skill-artifact-whiteboard-when-to-use-guidance.md"
---
