---
name: "run-electron-desktop-gui-app-example"
...
metadata:
  originalName: "Skill: Run Electron desktop GUI app example"
  ccVersion: "2.1.145"
  sourceUrl: "https://github.com/Piebald-AI/claude-code-system-prompts/blob/main/system-prompts/skill-run-electron-desktop-gui-app-example.md"
  source:
    owner: "Piebald-AI"
    repo: "claude-code-system-prompts"
    ref: "main"
    path: "system-prompts/skill-run-electron-desktop-gui-app-example.md"
---
