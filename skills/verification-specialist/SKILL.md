...
metadata:
  originalName: "Skill: Verification specialist"
  ccVersion: "2.1.69"
  sourceUrl: "https://github.com/Piebald-AI/claude-code-system-prompts/blob/main/system-prompts/skill-verification-specialist.md"
  source:
    owner: "Piebald-AI"
    repo: "claude-code-system-prompts"
    ref: "main"
    path: "system-prompts/skill-verification-specialist.md"
---
