...
metadata:
  originalName: "Skill: /dream memory consolidation"
  ccVersion: "2.1.119"
  sourceUrl: "https://github.com/Piebald-AI/claude-code-system-prompts/blob/main/system-prompts/skill-dream-memory-consolidation.md"
  source:
    owner: "Piebald-AI"
    repo: "claude-code-system-prompts"
    ref: "main"
    path: "system-prompts/skill-dream-memory-consolidation.md"
---
