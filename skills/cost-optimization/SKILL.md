...
metadata:
  originalName: "Skill: Cost optimization"
  ccVersion: "2.1.247"
  sourceUrl: "https://github.com/Piebald-AI/claude-code-system-prompts/blob/main/system-prompts/skill-cost-optimization.md"
  source:
    owner: "Piebald-AI"
    repo: "claude-code-system-prompts"
    ref: "main"
    path: "system-prompts/skill-cost-optimization.md"
---
