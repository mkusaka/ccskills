---
name: "multiplayer-whiteboard-description"
...
metadata:
  originalName: "Skill: Multiplayer whiteboard description"
  ccVersion: "2.1.260"
  sourceUrl: "https://github.com/Piebald-AI/claude-code-system-prompts/blob/main/system-prompts/skill-multiplayer-whiteboard-description.md"
  source:
    owner: "Piebald-AI"
    repo: "claude-code-system-prompts"
    ref: "main"
    path: "system-prompts/skill-multiplayer-whiteboard-description.md"
---
